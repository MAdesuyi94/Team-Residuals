...
#Export to pkl file
training_clean_full.to_pickle(folder+'training_clean_full.pkl')
...
#    ax = sns.distplot(a=s,color='covid_vaccination',data=training_clean_full,
#                      stat='count',multiple='stack')
#    ax.set_title('Histogram Plot of Vaccinated vs. '+s)
#    hist.savefig(folder+'\\Plots\\Histogram Plot of Vaccinated vs.'+s+'.png')
